...
public class ScanExecQuery extends ScanQuery {
    public ScanExecQuery(Session session, long beginTStamp, long endTStamp,
            MemRange[] ranges, Termination termination, Listener listener) {
    	super(session, beginTStamp, endTStamp, "INSTR_EXEC", ranges, termination);
    ...
    void handleResult(JSONObject object) throws JSONParserException {
    	...
    	if (type != null && type.equals("normal")) {
    		...
    		listener.notifyExecResult(this,
